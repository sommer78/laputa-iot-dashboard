<template>
  <a-form layout="vertical" v-if="data" :key="data.key">
    ...
    <a-form-item label="选项" v-if="hasKey('options')">
      ...
      <template v-else>
        <template
          v-if="data.type === 'radio' || (data.type === 'select' && data.options.mode === null)"
        >
                  ...
                  <a-radio :value="element.value" style="margin-right: 0px">
                    ...
                    <a-input
                      ...
                      :style="{
                        ...
                        border: data.options.showLabel ? '1px solid #d9d9d9' : 'none',
                      }"
                      v-model:value="element.label"
                    />
                  </a-radio>
                  <SvgIcon style="margin: 0; cursor: move" name="item" className="drag-item" />
                  <a-button
                    type="primary"
                    shape="circle"
                    size="small"
        ...
        <template
          v-if="data.type === 'checkbox' || (data.type === 'select' && data.options.mode !== null)"
        >
