...
import ButtonRender, { ButtonRenderProps } from '/@/components/LaputaBpmn/button-render';
  ...
  render() {
    ...
    return (
      <div class="bpmn-actions">
        ...
        <ElDrawer size="35%" direction="ltr" withHeader={false} v-model={this.previewActive}>
          <textarea id="xml-highlight-container" v-model={this.xml}  style="display: none" />
        </ElDrawer>
        <input
          type="file"
