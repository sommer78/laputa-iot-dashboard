export default {
  Seconds:{
      name:'Seconds',
      every:'Every second',
      interval:['Every','second(s) starting at second', 'second'],
      specific:'Specific second (choose one or many)',
      cycle:['Every second between second','and second', 'second']
  },
  Minutes:{
      name:'Minutes',
      every:'Every minute',
      ...
      cycle:['Every minute between minute','and minute', 'minute']
  },
  Hours:{
      name:'Hours',
      every:'Every hour',
      ...
      cycle:['Every hour between hour','and hour', 'hour']
  },
  Day:{
      name:'Day',
      every:'Every day',
