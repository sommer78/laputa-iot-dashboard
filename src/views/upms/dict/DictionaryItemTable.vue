<template>
  <div class="m-4 mr-0 overflow-hidden bg-white dictionary">
...
<script lang="ts">
  ...
  import { fetchItemList, deleteItemByIds } from '/@/api/upms/dict';
  import { PageWrapper } from '/@/components/Page';
  import { useMessage } from '/@/hooks/web/useMessage';
  import { useModal } from '/@/components/Modal';

  import { itemColumns, dictionaryItemSearchFormSchema } from './dict.data';
