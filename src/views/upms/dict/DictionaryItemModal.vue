...
<script lang="ts">
  ...
  import { dictionaryItemFormSchema } from './dict.data';
  import { putDictItem, getItemDetails } from '/@/api/upms/dict';
        ...
        return [
          {
            ...
            validator: (_, value)=>{
              if(value){
                return getItemDetails({id: params.id, field: params.field, fieldValue: value, fieldName:params.fieldName}).then(res=>{
                  if(res){
