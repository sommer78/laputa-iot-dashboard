<template>
  <BasicModal wrapClassName="selector-body" v-bind="$attrs" @register="registerModal" :title="getTitle" @ok="handleSubmit">
    <div class="selected-items">
      <Tag v-for="item in selectedList"   v-bind:key="item.id" color="processing" closable @close="removeSelectedItem(item.code)">{{item.name}}</Tag>
    </div>
...
<script lang="ts">
  ...
  import { getStaffPageList } from '/@/api/org/staff';
